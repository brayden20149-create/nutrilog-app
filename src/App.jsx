              ...
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8}}>
                <span style={{fontSize:10,color:T.info,letterSpacing:"0.1em"}}>WATER
                  <InfoDot title="Water tracking">
                    Tap +12 oz each time you finish a glass/bottle — it adds up through the day.
                    The bar fills toward a 100 oz daily target (a common general guideline; your
                    real needs vary with body size, climate, and activity). Tap "reset" to clear the day.
                  </InfoDot>
                </span>
                {(water[selDay]||0)>0 && (
